...
class ApplicantsController extends Controller
{
    ...
    public function index()
{
    $applicants = applicants::all()->map(function ($applicant) {
        return [
            'id' => $applicant->id,
            'applicant_name' => $applicant->applicant_name,
            'cnic_no' => $applicant->cnic_no,
    ...
    $plots = plots::all()->map(function ($plot) {
        return [
            'id' => $plot->id,
    ...
    // Merge the $applicants and $plots arrays
    $data = [
    ...
    return Inertia::render("BallotingType", $data);
}
