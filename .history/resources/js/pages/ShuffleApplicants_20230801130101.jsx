...
function ShuffleApplicants({ shuffledApplicants}) {
    const[data,setData]=useState([])
    useEffect(()=>{
        setData(shuffledApplicants)
    })
    console.log(shuffledApplicants);
                    ...
                    <tbody>
                       
                            {
                                data.map((applicant,index)=>{
                                    ...
                                    <td className="px-6 py-4">{data.applicant_name}</td>
                                    <td className="px-6 py-4">{data.cnic_no}</td>
