...
function Shuffle() {
    ...
    const { filteredApplicants } = usePage().props;
                    ...
                    <div className="flex flex-row">
                        ...
                        <div className="relative mr-3">
                            ...
                            {open && (
                                ...
                                >
                                    <ul>
                                        <li className="hover:bg-gray-100 ">10</li>
                                        <li className="hover:bg-gray-100">25</li> <li className="hover:bg-gray-100">100</li> <li className="hover:bg-gray-100">All</li>
                                    </ul>
                                </div>
                            )}
                        </div>
