...
function BallotingType({ applicants }) {
   ...
   const handleSubmit = (e) => {
        ...
        // Use Inertia.share to pass the filteredApplicants data to the Shuffle page
        Inertia.share({ filteredApplicants: selectedTehsilApplicants });

        Inertia.visit("/shuffle");
    };
