    ...
    return (
        <div className=" ">
            ...
            <div className="flex flex-row justify-center items-center">
                <input
                    type="text"
                    className="bg-green-600 mr-4 text-white p-4 w-16 md:w-28 md:h-28 h-16 shadow outline-none rounded-lg"
                    maxLength="1"
                ...
                <input
                    type="text"
                    className="bg-green-600 mr-4 text-white p-4 w-16 md:w-28 md:h-2 h-16 shadow outline-none rounded-lg"
                    maxLength="1"
                    onChange={(e) => handleInputChange(index, e.target.value)}
                />
                <input
