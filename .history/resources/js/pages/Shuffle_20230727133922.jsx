...
function Shuffle({ filteredApplicants = "[]" }) {
    ...
    const handleStart = () => {
        ...
        const route = route("draw.index"); // Replace "draw.index" with the correct route name for the "Draw" component
        Inertia.visit(route, { data: { filteredApplicants: shuffledArray } });
      };
