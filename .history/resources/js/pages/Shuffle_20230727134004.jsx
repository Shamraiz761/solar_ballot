...
function Shuffle({ filteredApplicants = "[]" }) {
    ...
    const handleStart = () => {
        // Navigate to the "draw" page with the shuffled applicants data using the post method
        // Make sure you use the correct route and component name here
         // Replace "draw.index" with the correct route name for the "Draw" component
        Inertia.visit('/draw', { data: { filteredApplicants: shuffledArray } });
      };
    ...
    return (
        <div className=" ">
            ...
            <div className="flex flex-row items-center justify-center my-5 ">
                <button onClick={handleShuffle} className="px-12 py-4 text-lg font-bold mr-3 rounded-lg bg-gray-900 hover:bg-green-600 text-white uppercase md:text-2xl ">
                    Shuffle
                </button>
                <button
                    onClick={handleStart}
