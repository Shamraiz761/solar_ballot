...
console.log(currentDate);
    ...
    const formattedApplicants = applicantsArray.map((applicant) => {
    ...
    return (
        <div className=" ">
            {loading ? (
                ...
                <div>
                    <Banner />
                    <div class="m-5 bg-green-500 text-white py-2 text-xl md:text-2xl my-5 uppercase ">
                        <h1 className="text-center font-bold">
                            BALLOT DATE : {currentDate}
                        </h1>
                        <h1 className="text-center font-bold">
                            BALLOT TIME : {currentTime}
                        </h1>
                    </div>
                    ...
                    <div className="bg-gray-500 hover:bg-gray-600 text-white font-bold rounded-md mx-3 my-5 p-5">
                        ...
                        <div className="flex flex-row justify-between items-center py-2 text-lg bg-gray-600 px-4">
                            <span>Applicants</span>
                            <span>{applicantsArray.length}</span>
                        </div>
                        <div className="flex flex-row justify-between items-center py-2 text-lg bg-gray-600 px-4">
                    ...
                    <div className="m-5 my-8 flex-wrap text-lg font-medium">
                        <h1 className="text-center bg-green-600 py-2 text-white text-xl mb-5 font-semibold uppercase">
                            Applicants
                        </h1>
