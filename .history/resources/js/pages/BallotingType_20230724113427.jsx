	     ...
	     <div class="selection_form">
	     	<form name="selction_form" method="post" action="http://localhost/solar_1kw_ballot/balloting/home">
                ...
                <div className="min-h-[50vh] flex justify-center items-center">
                    <label className='inline-block text-xl md:text-2xl font-medium  text-gray-700'>Select Balloting Type</label>
                    <select onChange={onOptionChangeHandler} className="py-2 text-xl md:text-2xl text-gray-700 font-medium  border border-gray-600 w-[200px] outline-none">
