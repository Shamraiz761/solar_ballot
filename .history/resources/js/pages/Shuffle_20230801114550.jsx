            ...
            {loading ? (
                ...
                <div>
                    ...
                    <div className="m-5 my-8 flex-wrap text-lg font-medium">
                        ...
                        <div className="my-5">
                            <button className="py-2 w-16 rounded-md bg-blue-600 hover:bg-green-600 text-lg font-medium text-white  ">Applicants</button>
                        
                            <button className="py-2 w-16 rounded-md bg-blue-600 hover:bg-green-600 text-lg font-medium text-white  gap-4">Plots</button>
</div>
