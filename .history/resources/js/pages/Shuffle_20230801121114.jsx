...
function Shuffle({ filteredApplicants = "[]" , shuffledData}) {
    ...
    const handleShuffle = () => {
        ...
        setShuffledData(shuffledApplicantsArray); 
        setTimeout(() => {
            setLoading(false);
        }, 1000);
        // setLoading(false)
    ...
    const applicants = () => {
        ...
        setLoading(true);
        Inertia.get("/shuffleApplicants");
    };

    const plots = () => {
       
        setLoading(true);
        Inertia.get("/shufflePlots");
    };
    return (
        <div className=" ">
            {loading ? (
                ...
                <div>
                    ...
                    <div className="m-5 my-8 flex-wrap text-lg font-medium">
                        ...
                        <div className="my-5">
                            <button onClick={applicants} className="py-2 w-36 rounded-md bg-blue-600 hover:bg-green-600 text-lg font-medium text-white  ">Applicants</button>
                        
                            <button onClick={plots} className="py-2 w-36 rounded-md bg-blue-600 hover:bg-green-600 text-lg font-medium text-white  ml-4">Plots</button>
</div>

                        {/* <ShuffleTable filteredApplicants={shuffledArray} /> */}
                    </div>
                </div>
            )}
        </div>
