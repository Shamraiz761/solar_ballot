    ...
    return (
        <div className=" ">
            ...
            <div className="flex flex-row justify-center">
                <button className="inline-block items-center bg-gray-900 mb-5 px-4 md:px-16 py-3 text-2xl font-bold rounded-md text-white hover:bg-green-600">
                    Generate PDF
                </button>
            </div>

            <div className="m-5 my-8 flex-wrap text-lg font-medium">
                <h1 className="text-center text-xlmb-5 font-semibold uppercase">
                    Applicants
                </h1>
