...
function Draw() {
  return (
    ...
    <h1 className='my-5 font-bold text-4xl text-gray-800 uppercase '>summary</h1>

    <div className='bg-gray-500 hover:bg-gray-600 text-white font-bold'>
        <h1 className='uppercase text-center'>Applicants</h1>
    </div>
    </div>
  )
}
