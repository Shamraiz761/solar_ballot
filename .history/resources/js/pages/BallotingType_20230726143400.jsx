...
function BallotingType({ applicants }) {
    ...
    const handleSubmit = (e) => {
        ...
        // Convert selectedTehsilApplicants into a JSON string and encode it for use in the URL
        const encodedApplicants = encodeURIComponent(JSON.stringify(selectedTehsilApplicants));
      
        // Pass the encodedApplicants as a query parameter in the URL
    ...
    console.log(selectedTehsilApplicants);
    return (
        <div className=" ">
            <Banner />
                ...
                <div className="flex justify-center items-center flex-col bg-gray-100 w-[80vw] py-8">
                    <form onSubmit={handleSubmit} className="flex flex-row">
                        ...
                        <div className="relative">
                            ...
                            {isOpen && (
                                <div className="fixed bottom-10 z-50 w-[200px] shadow bg-white">
