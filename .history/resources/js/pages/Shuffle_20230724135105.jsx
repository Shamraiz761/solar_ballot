    ...
    return (
        <div className=" ">
            ...
            <div className="flex flex-row items-center justify-center my-3 ">
                <button
                    className="px-12 py-4 text-lg font-bold mr- rounded-lg bg-gray-900 hover:bg-green-600 text-white uppercase md:text-2xl "
                >
                    Shuffle
                </button>
                <button
                    className="px-12 py-4 text-lg font-bold rounded-lg bg-gray-900 hover:bg-green-600 text-white uppercase md:text-2xl "
                >
