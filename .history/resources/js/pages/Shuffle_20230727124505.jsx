...
function Shuffle({ filteredApplicants = "[]" }) {
    ...
    const shuffle = () => {
        ...
        // For example, you can shuffle the applicantsArray using a random algorithm
        // For simplicity, let's just reverse the applicantsArray for demonstration purposes
        const shuffledApplicants = [...applicantsArray].reverse();
    
        // Perform any other operations you need on the shuffled applicants data
        // ...
    
        // Return the shuffled applicants data
        return shuffledApplicants;
      };
      ...
      const handleSubmit = (e) => {
        ...
        const data = {
          filteredApplicants: shuffle(), // Call the shuffle function here to get the shuffled applicants data
          keys: keys.join(""), // Convert the array of keys to a single string
        };
    
        // Post data to the "/shuffle" route
        Inertia.post("/shuffle", data).then(() => {
          // Redirect to the "/draw" route after successful post
          Inertia.visit("/draw");
        });
      };
