...
import PlotTable from "../components/tables/ShuffleTable";
            ...
            {loading ? (
                ...
                <div>
                    ...
                    <div className="m-5 my-8 flex-wrap text-lg font-medium">
                        ...
                        <div className="my-5">
                            <button onClick={()=>setType('Applicants')} className="py-2 w-36 rounded-md bg-blue-600 hover:bg-green-600 text-lg font-medium text-white  ">Applicants</button>
                        
                            <button onClick={()=>setType('Plots')} className="py-2 w-36 rounded-md bg-blue-600 hover:bg-green-600 text-lg font-medium text-white  ml-4">Plots</button>
</div>

{
    type == 'Applicants' && <div> <ShuffleTable filteredApplicants={shuffledArray} /></div>
}
{
    type == 'Plots' && <div><PlotTable /></div>
}
