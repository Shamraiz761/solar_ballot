...
function Shuffle({ filteredApplicants = "[]" }) {
    ...
    useState[applicantsArray,setApplicantsArray]=useState
    ...
    return (
        <div className=" ">
            ...
            <div className="flex flex-row items-center justify-center my-5 ">
                <button onClick={shuffle} className="px-12 py-4 text-lg font-bold mr-3 rounded-lg bg-gray-900 hover:bg-green-600 text-white uppercase md:text-2xl ">
                    Shuffle
                </button>
                <Link
                    href="/draw"
