...
function Shuffle({ filteredApplicants = "[]" }) {
    ...
    const handleStart = () => {
        ...
        Inertia.get("/draw", { filteredApplicants: JSON.stringify(applicantsArray) });
      };
    ...
    return (
        <div className=" ">
            ...
            <div className="flex flex-row items-center justify-center my-5 ">
                ...
                <button onSubmit={handleStart} className="px-12 py-4 text-lg font-bold rounded-lg bg-yellow-600 hover:bg-green-600 text-white uppercase md:text-2xl ">
                    Start
                </button>
            </div>
