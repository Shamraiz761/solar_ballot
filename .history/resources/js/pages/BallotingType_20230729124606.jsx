...
function BallotingType({ applicants }) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            // Simulate an API call or data fetching from the server using Inertia.post
            // Replace this with your actual Inertia.post request to fetch data
            const response = await Inertia.post(`/shuffle?filteredApplicants=${encodedApplicants}`);
