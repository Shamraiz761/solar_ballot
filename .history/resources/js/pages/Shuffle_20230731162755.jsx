        ...
        <div className=" ">
            {loading ? (
                ...
                <div>
                    ...
                    <div className="m-5 my-10 bg-green-500 text-white py-2 text-xl md:text-4xl uppercase ">
                    ...
                    <div className="m-5 my-8 flex-wrap text-lg font-medium">
                        <h1 className="bg-green-600 text-white text-center text-xl font-semibold uppercase mb-5">
                            Applicants
                        </h1>
