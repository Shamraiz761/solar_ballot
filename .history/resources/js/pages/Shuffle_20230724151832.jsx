    ...
    return (
        <div className=" ">
          ...
          <i className="icon-reset"></i> Reset
            ...
            <div className="m-5 my-8 flex-wrap text-lg font">
                <h1 className="text-center text-xl">Applicants</h1>
                ...
                <div className="flex flex-row justify-between">
                    ...
                    <div className="mb-4">
                        ...
                        <input type="search" name="search" className="rounded-full px-2 py-1 outline-none border border-gray-400" id="" />
                    </div>
                </div>
