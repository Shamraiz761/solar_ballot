...
function Shuffle({ filteredApplicants = "[]" }) {
    ...
    const handleShuffle = () => {
        ...
        console.log(shuffledApplicantsArray);
    };
    ...
    const handleStart = () => {
        const shuffledApplicants = shuffleArray(applicantsArray);

        // Convert the shuffled array into a JSON string
        const shuffledApplicantsJson = JSON.stringify(shuffledApplicants);

        // Navigate to the "draw" page with the shuffled applicants data using the get method
        Inertia.get("/draw", {
            filteredApplicants: shuffledApplicantsJson, // Use the same key as in the "Draw" component
        });
    };
